...
export function TransactionsPage() {
  return (
    <div className="p-4 lg:p-5 space-y-7 lg:space-y-8 max-w-7xl mx-auto w-full">
      ...
      {/* Filter Bar */}
      <section className="bg-emerald-zenith-surface rounded-xl p-3.5 md:p-4 flex flex-wrap items-center justify-between gap-4 border border-emerald-zenith-text-muted/15 shadow-sm">
