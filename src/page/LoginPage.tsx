...
import { Wallet, Eye, EyeOff, Github } from 'lucide-react';
      ...
      >
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <p className="mt-10 text-center text-sm text-slate-500 dark:text-emerald-100/40">
            New to FinTrack?{' '}
            <a href="#" className="font-semibold leading-6 text-emerald-600 dark:text-emerald-400 hover:text-emerald-500">
              Create an account
            </a>
          </p>
        </div>
